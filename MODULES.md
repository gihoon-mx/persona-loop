...
| M05 | persona-builder | `agents/persona-builder/` | **응답자별 프로필 → 개인 기반 페르소나 생성** (중심 응답자 선정 · 근거에 respondentLabel 필수 · behaviorModel 도출). Claude API, 결과는 Firestore에 기록 | 예정 (사양 확정 v0.5) |
