...
상세 설계는 [ARCHITECTURE.md](ARCHITECTURE.md), 모듈 규칙은 [MODULES.md](MODULES.md), Firebase 셋업은 [docs/FIREBASE-SETUP.md](docs/FIREBASE-SETUP.md), 진행 상태는 [WORKLOG.md](WORKLOG.md) 참고.
...
| 2 | 페르소나 빌더 (서베이 → 페르소나, 근거 인용 포함) | 🔶 뷰어 완성, 생성 Agent 예정 |
| 3 | 데모 리뷰어 (Agent가 실제 브라우저로 데모 사용 + 리뷰 작성) | 🔶 뷰어·세션 리플레이 완성, Agent 예정 |
